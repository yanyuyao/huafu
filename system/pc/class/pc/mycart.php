<?php
        ...
        if ($op == 'add') {
            ...
            $goods = mysqld_select("SELECT id, type, total,marketprice FROM " . table('shop_goods') . " WHERE id = :id and deleted=0 and status=1", array(':id' => $goodsid));
            if (empty($goods)) {
