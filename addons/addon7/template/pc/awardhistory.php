...
<body>
	<section class="order">
		...
		<div class="wx_nav"><a href="<?php  echo create_url('pc',array('name' => 'pc','do' => 'shopindex'))?>" data-href="###" ptag="37080.1.1" class="nav_index on">首页</a><a href="<?php  echo create_url('pc',array('name' => 'pc','do' => 'listCategory'))?>"  ptag="37080.1.2" class="nav_search" style="display:">分类</a><a href="<?php  echo create_url('pc',array('name' => 'pc','do' => 'mycart'))?>"  ptag="37080.1.3" class="nav_shopcart">购物车</a><a href="<?php  echo create_url('pc',array('name' => 'pc','do' => 'fansindex'))?>"  ptag="37080.1.4" class="nav_me">个人中心</a></div>
	</body>
</html>